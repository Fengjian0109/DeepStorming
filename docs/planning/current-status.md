...
1. `pnpm check`：通过；Prettier、全 workspace typecheck、38 个测试文件 / 441 个测试，以及桌面端构建全部通过。
...
继续执行 `docs/superpowers/plans/2026-07-12-pdf-document-foundation.md` Task 4：Application import use case。发布侧继续处理真实云 Provider 手动验收、签名、图标与公证。
